...
public class TestOnboardingStep1 extends BaseTestClass {
	...
	@Test
		...
		//Assert.assertEquals(ObjectStep1.Method_VerifyQuestionTest(), "Pick your three most important challenges?");
		...
		ObjectStep1.Method_GetOptionsByName(prop.getProperty("Step1option1"), prop.getProperty("Step1option2"), prop.getProperty("Step1option3"));
